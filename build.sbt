...
libraryDependencies += "io.get-coursier" %% "coursier-core" % "2.0.10"
...
libraryDependencies += "io.get-coursier" %% "coursier" % "2.0.10"
libraryDependencies += "io.get-coursier" %% "coursier-cats-interop" % "2.0.10"
