...
libraryDependencies += "eu.timepit" %% "refined" % "0.9.19"
...
libraryDependencies += "org.http4s" %% "http4s-blaze-client" % "0.21.14"
libraryDependencies += "org.scalameta" %% "scalameta" % "4.4.3"
