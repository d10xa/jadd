...
libraryDependencies += "io.get-coursier" %% "coursier" % "2.1.5" cross CrossVersion.for3Use2_13
libraryDependencies += "io.get-coursier" %% "coursier-core" % "2.1.5" cross CrossVersion.for3Use2_13
