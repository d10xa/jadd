...
libraryDependencies += "io.get-coursier" %% "coursier-core" % "2.0.0-RC6-25"
...
libraryDependencies += "io.lemonlabs" %% "scala-uri" % "2.3.0"
libraryDependencies += "org.http4s" %% "http4s-blaze-client" % "0.21.7"
